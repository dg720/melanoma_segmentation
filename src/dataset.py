...
# for every image we have 4 variations: horizontal, vertical flip and rotation
...
print(
    "Start loading the Test(!!!) images and masks , and augment each image in 3 types "
)
...
np.save("C:/Data-Sets/temp/Unet-Train-Melanoa-Images.npy", allImagesNP)
np.save("C:/Data-Sets/temp/Unet-Train-Melanoa-Masks.npy", maskImagesNP)

print("Save the Test Data : ")
np.save("C:/Data-Sets/temp/Unet-Test-Melanoa-Images.npy", allTestImagesNP)
np.save("C:/Data-Sets/temp/Unet-Test-Melanoa-Masks.npy", maskTestImagesNP)
